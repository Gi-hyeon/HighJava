...
//		File file1 = new File("d:\\d_other\\test.txt"); // 구분문자를 '\'로 사용한 경우
		...
		System.out.println("디렉토리? : " + file1.isDirectory()); // 경로가 directory인지 확인
		System.out.println("파일? : " + file1.isFile()); // 경로가 file인지 확인한다.
		System.out.println();
		
		
		File file2 = new File("d:/d_other"); // 구분문자를 '/'로 사용한 경우
		...
		File file3 = new File(file2, "test.txt"); // d_other 폴더 안에 있는 test.txt
		...
		// -> 'parent'디렉토리 안에 있는 'child'파일을 갖는다 -> parent를 String으로 가진다.
